...
<head>
    ...
    <title>Staff - Booking System</title>
...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-3" href="">Booking System - Staff</a>
    <!-- Sidebar Toggle-->
    ...
    <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                ...
                <li><a class="dropdown-item" href="{{route('staff.logout')}}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a>
                ...
                <div class="nav">
                    ...
                    <div class="collapse" id="collapseBookings" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="{{route('staff.bookings.allbookings')}}">All Bookings</a>
                            <a class="nav-link" href="{{route('staff.mybooking.createbooking')}}">Create Booking</a>
                        </nav>
                    </div>
                    ...
                    <div class="collapse" id="collapseReports" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="{{route('staff.analytics')}}">Analytics</a>
                        </nav>
                    </div>
                    ...
                    <div class="collapse" id="collapseUsers" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="{{route('staff.users.customers')}}">Customers</a>
                        </nav>
                    </div>
