                                ...
                                <div class="card-body">
                                    <form method="POST" action="{{route('register')}}">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-12">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input name="name" value="{{ old('name') }}" class="form-control" id="inputFirstName" type="text" placeholder="Enter your Name" />
                                        ...
                                        <div class="form-floating mb-3">
                                            <input name="email" value="{{ old('email') }}" class="form-control" id="inputEmail" type="email" placeholder="name@example.com" />
